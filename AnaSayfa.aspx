<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="Yemek_Sitem.WebForm1" %>
    ...
    <asp:DataList ID="DataList2" runat="server" Width="441px">
        <ItemTemplate>
            <table class="auto-style5">
                <tr>
                    <td style="text-align: center; background-color: #FFCC99">
                    ...
                    <a href="YemekDetay.aspx?Yemekid=<%#Eval("Yemekid")%>"><asp:Label ID="Label3" runat="server" ForeColor="#660033" style="font-weight: 700; font-size: x-large; text-align: center" Text='<%# Eval("YemekAd") %>'></asp:Label></a>
